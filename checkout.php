...
if(isset($_POST['submit'])){
    ...
    $payment_status='success';
    $_SESSION['total_order_price'] = $total_price;  // Move this line up
...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(checkout.webp) no-repeat scroll center center / cover ;">
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method">
													...
													&nbsp;&nbsp;PhonePe <input type="radio" name="payment_type" value="payu" required/>
												</div>
												<div class="single-method">
