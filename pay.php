...
if (isset($_SESSION['total_order_price'])) {
    $total_order_price = $_SESSION['total_order_price'];
    // ... use $total_order_price as needed
} else {
    // Handle the case where the session variable is not set
    echo "Total order price not available.";
}
...
$redirectUrl = 'https://127.0.0.1/af/payment-success.php';
...
$mobile=9999999999;
$amount = $total_order_price; // amount in INR
